...
class AbstractTourPage(Page):
    ...
    yt_vid = models.CharField(max_length=22, default='UHLdLtEiFGs', help_text=_("For example: https://www.youtube.com/watch?v=UHLdLtEiFGs >> ID = UHLdLtEiFGs. This video will be shown in the Tours Watch Video."), verbose_name="Youtube Video ID")
