...
class ExploreBlock(blocks.StructBlock):
    ...
    blocks.StructBlock([
        ...
        ('icon_1', ImageChooserBlock(required=False, help_text="56px x 56px")),
        ...
        ('icon_2', ImageChooserBlock(required=False, help_text="56px x 56px")),
        ...
        ('icon_3', ImageChooserBlock(required=False, help_text="56px x 56px")),
        ...
        ('icon_4', ImageChooserBlock(required=False, help_text="56px x 56px")),
